  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20">
      <div className="max-w-6xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="z-10 transform translate-y-0" style={{ transform: `translateY(${scrollY * 0.1}px)` }}>
          ...
          <div className="flex flex-wrap gap-4">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
              View Work
            </button>
            <button
              onClick={() => document.getElementById("contact").scrollIntoView({ behavior: "smooth" })}
              className="border border-blue-600 text-blue-400 hover:bg-blue-600 hover:text-white px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105">
              Contact Me
            </button>
            <a
              href={Sandeep_Anand_Resume}
              download
              className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center">
        ...
        <div className="relative z-10 hidden lg:block">
          <div className="relative h-96 w-96 mx-auto transform rotate-3 hover:rotate-6 transition-transform duration-500">
